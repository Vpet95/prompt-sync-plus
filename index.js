...
const TERMINATING_KEY = 13;
const autocompleteStrategies = ["cycle", "suggest"];
...
function create(config) {
  ...
  function prompt(ask, value, opts) {
    ...
    function autocompleteCycle() {
      ...
      if (autoCompleteSearchTerm === undefined) autoCompleteSearchTerm = str;
